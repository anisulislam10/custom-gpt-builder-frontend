...
(function () {
    ...
    link.rel = 'stylesheet';
    link.href = `https://custom-gpt-builder-frontend.vercel.app/styles/chatbot.css`; // You'll create this CSS file
    ...
    widgetScript.src = `https://custom-gpt-builder-frontend.vercel.app/widget.bundle.js`;
    widgetScript.onload = () => {
