...
(function () {
    ...
    link.rel = 'stylesheet';
    link.href = `https://custom-gpt-backend-sigma.vercel.app/styles/chatbot.css`; // You'll create this CSS file
    ...
    widgetScript.src = `https://custom-gpt-backend-sigma.vercel.app//widget.bundle.js`;
    widgetScript.onload = () => {
