...
window.initChatbotWidget = function(config) {
    ...
    iframe.src = `https://custom-gpt-backend-sigma.vercel.app/chatbot-widget?flowId=${config.flowId}&theme=${encodeURIComponent(JSON.stringify(config.theme))}`;
    ...
    window.addEventListener('message', (event) => {
      if (event.origin !== 'https://custom-gpt-backend-sigma.vercel.app/') return;
