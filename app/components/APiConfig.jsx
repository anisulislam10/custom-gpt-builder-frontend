...
import { fetchApiConfig, saveApiConfig } from '../../store/apiConfigSlice';
...
const ApiConfigModal = ({ isOpen, onClose, apiConfig, onSave }) => {
  ...
  const [activeTab, setActiveTab] = useState(config.provider || 'openai');
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        {activeTab === 'openai' && (
          <div className="space-y-4">
            ...
            <select
              value={config.openai.model || 'gpt-3.5-turbo'}
